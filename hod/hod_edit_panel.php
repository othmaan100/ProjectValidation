...
if (!$panel_id) {
    header("Location: hod_manage_panels.php");
    exit();
}
...
<body>
    ...
    <div class="container">
        <div class="header">
            ...
            <a href="hod_manage_panels.php" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Back to Panels</a>
        </div>
                ...
                <form method="POST">
                    ...
                    <div class="two-col-grid">
                        <div class="form-group" style="margin-bottom: 0;">
                            ...
                            <input type="date" id="panel_date" name="panel_date" value="<?= htmlspecialchars($panel['panel_date'] ?? '') ?>">
                        </div>
                        <div class="form-group" style="margin-bottom: 0;">
                            <label for="panel_time">Time</label>
                            <input type="time" id="panel_time" name="panel_time" value="<?= htmlspecialchars($panel['panel_time'] ?? '') ?>">
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div class="card">
                ...
                <?php else: ?>
                    <div style="text-align: center; padding: 40px; color: var(--text-muted);">
                        ...
                        <a href="hod_assign_panels.php" class="btn btn-secondary">Assign Students</a>
                    </div>
                <?php endif; ?>
            </div>
        </div>
