...
<head>
    <meta charset="UTF-8">
    <title>Panel Update Approved Topics - HOD</title>
...
<body>
    ...
    <div class="page-container">
        <div class="header-card">
            ...
            <a href="hod_panel_pending_topics.php" class="btn" style="background:#2d3436; text-decoration:none;"><i class="fas fa-arrow-right"></i> Go to Pending Topics</a>
        </div>
