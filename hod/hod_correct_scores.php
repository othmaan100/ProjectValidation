...
<body>
    ...
    <div class="container">
        ...
        <div class="header">
            ...
            <a href="hod_view_assessments.php" class="btn btn-outline"><i class="fas fa-arrow-left"></i> Back to Assessments</a>
        </div>
    ...
    <script>
        ...
        document.getElementById('correctForm').addEventListener('submit', async function (e) {
            ...
            try {
                const res = await fetch('hod_correct_scores.php', { method: 'POST', body: fd });
