...
<head>
    ...
    <title>HOD Dashboard - Project Validation System</title>
    ...
    <div class="dashboard-container">
        ...
        <div class="stats-grid">
            ...
            <div class="stat-card">
                ...
                <div class="stat-info"><h3><?php echo $pending_topics; ?></h3><p>Pending Review</p></div>
            </div>
            <div class="stat-card">
                <div class="stat-icon icon-green"><i class="fas fa-check-double"></i></div>
                <div class="stat-info"><h3><?php echo $approved_topics; ?></h3><p>Approved Topics</p></div>
            </div>
            <div class="stat-card">
                <div class="stat-icon icon-purple"><i class="fas fa-file-alt"></i></div>
                <div class="stat-info"><h3><?php echo $total_topics; ?></h3><p>Total Submissions</p></div>
            </div>
        </div>
        ...
        <div class="action-grid">
            <div class="action-card">
                ...
                <a href="hod_topic_validation.php" class="action-btn">Launch Validation Page <i class="fas fa-arrow-right"></i></a>
            </div>
            <div class="action-card">
                <i class="fas fa-user-friends"></i>
                <h2>Manage Students</h2>
                <p>View and manage all students in your department. Register new students or update their profile information.</p>
                <a href="hod_manage_students.php" class="action-btn">Manage Students <i class="fas fa-arrow-right"></i></a>
            </div>
            <div class="action-card">
                ...
                <a href="hod_manage_supervisors.php" class="action-btn">Manage Supervisors <i class="fas fa-arrow-right"></i></a>
            </div>
            <div class="action-card">
                ...
                <a href="hod_assign_supervisors.php" class="action-btn">Assign Supervisors <i class="fas fa-arrow-right"></i></a>
            </div>
            <div class="action-card">
                ...
                <a href="hod_submission_schedule.php" class="action-btn" style="background: #6f42c1;">Manage Schedule <i class="fas fa-clock"></i></a>
            </div>
            <div class="action-card">
                <i class="fas fa-users-rectangle"></i>
                <h2>Manage Panels</h2>
                <p>Create project defense panels, assign supervisors as members, and view detailed allocation lists.</p>
                <a href="hod_manage_panels.php" class="action-btn" style="background: #1cc88a;">Launch Panel Manager <i class="fas fa-arrow-right"></i></a>
            </div>
            <div class="action-card">
                <i class="fas fa-vial"></i>
                <h2>View Assessments</h2>
                <p>Monitor student defense scores given by panel members. View performance averages and print assessment reports.</p>
                <a href="hod_view_assessments.php" class="action-btn" style="background: #36b9cc;">View All Scores <i class="fas fa-arrow-right"></i></a>
            </div>
            <div class="action-card">
                ...
                <a href="hod_manage_submissions.php" class="action-btn" style="background: #27ae60;">Review Submissions <i class="fas fa-file-upload"></i></a>
            </div>
            <div class="action-card">
                ...
                <a href="hod_final_scores.php" class="action-btn" style="background: #e67e22;">View Final Scores <i class="fas fa-file-csv"></i></a>
            </div>
            <div class="action-card">
                ...
                <a href="hod_upload_guideline.php" class="action-btn" style="background: #6c5ce7;">Upload Guideline <i class="fas fa-upload"></i></a>
            </div>
            <div class="action-card">
                ...
                <a href="hod_chapter_settings.php" class="action-btn" style="background: #f39c12;">Set Chapters <i class="fas fa-cog"></i></a>
            </div>
            <div class="action-card">
                ...
                <a href="hod_chapter_reports.php" class="action-btn" style="background: #d35400;">View Progress <i class="fas fa-print"></i></a>
            </div>
            <div class="action-card">
            ...
            <div class="action-card">
                ...
                <a href="hod_change_password.php" class="action-btn" style="background: #e74a3b;">Change Password <i class="fas fa-key"></i></a>
            </div>
        </div>
    </div>
