    ...
    <div class="container">
        ...
        <div class="header no-print">
            ...
            <div style="display: flex; gap: 10px;">
                ...
                <a href="hod_manage_panels.php" class="btn btn-primary">Manage Panels</a>
            </div>
        </div>
        ...
        <?php else: ?>
            <div class="card" style="text-align: center; padding: 80px;">
                ...
                <a href="hod_manage_panels.php" class="btn btn-primary" style="margin-top: 20px;">Create First Panel</a>
            </div>
        <?php endif; ?>
    </div>
