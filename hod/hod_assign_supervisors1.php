...
// Fetch approved topics in the HOD's department
...
// Fetch supervisors in the HOD's department from the supervisors table
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['create_supervisor'])) {
    ...
    if (empty($name) || empty($email) || empty($staffNo) || empty($phone)) {
        ...
        if ($stmt->fetchColumn()) {
            ...
            header("Location: hod_assign_supervisors.php");
            exit();
        }
    }
}
                ...
                <tr>
                    ...
                    <td>
                        <div class="action-buttons">
                            <!-- Edit Link -->
                            <a href="hod_edit_supervisor.php?id=<?php echo $supervisor['id']; ?>" class="edit">Edit</a>
                            <!-- Delete Link -->
                            <a href="hod_delete_supervisor.php?id=<?php echo $supervisor['id']; ?>" class="delete" onclick="return confirm('Are you sure you want to delete this supervisor?')">Delete</a>
                        </div>
                    </td>
                </tr>
            <?php endforeach; ?>
