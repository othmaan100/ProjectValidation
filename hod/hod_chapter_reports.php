...
$num_chapters = (int)($hod_info['num_chapters'] ?? 5);
...
<body style="background: #f8fafc;">
    ...
    <div class="container" style="padding: 40px 20px;">
        ...
        <table class="report-table">
            ...
            <tbody>
                <?php 
                    if (!function_exists('renderClearance')) {
                        function renderClearance($status) {
                            if ($status == 'approved') {
                                return '<span style="color: #10b981; font-size: 18px;"><i class="fas fa-check-circle"></i></span>';
                            }
                            return '<span style="color: #cbd5e1; font-size: 18px;"><i class="fas fa-times-circle"></i></span>';
                        }
                    }
                ?>
                <?php $sn = 1; foreach ($report_data as $row): ?>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;"><?= renderClearance($row['proposal_status']) ?></td>
                        <td style="text-align: center;"><?= renderClearance($row['internal_status']) ?></td>
                        <td style="text-align: center;"><?= renderClearance($row['external_status']) ?></td>
                        <td>
