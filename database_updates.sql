...
-- ========================================================
-- Database Schema Updates for HOD Module
-- ========================================================

-- 3. Add 'hod' to the role enum in the users table
ALTER TABLE `users` MODIFY COLUMN `role` ENUM('stu','dpc','fpc','sup','admin','lib','ext','hod');
