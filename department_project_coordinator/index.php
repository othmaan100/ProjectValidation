    ...
    <div class="dashboard-container">
        ...
        <div class="action-grid">
            <div class="action-card">
                ...
                <a href="dpc_topic_validation.php" class="action-btn">Launch Validation Page <i class="fas fa-arrow-right"></i></a>
            </div>
            <div class="action-card">
                <i class="fas fa-user-friends"></i>
                <h2>Manage Students</h2>
                <p>View and manage all students in your department. Register new students or update their profile information.</p>
                <a href="dpc_manage_students.php" class="action-btn">Manage Students <i class="fas fa-arrow-right"></i></a>
            </div>
            <div class="action-card">
                ...
                <a href="dpc_manage_supervisors.php" class="action-btn">Manage Supervisors <i class="fas fa-arrow-right"></i></a>
            </div>
            <div class="action-card">
                ...
                <a href="dpc_assign_supervisors.php" class="action-btn">Assign Supervisors <i class="fas fa-arrow-right"></i></a>
            </div>
            <div class="action-card">
                ...
                <a href="dpc_submission_schedule.php" class="action-btn" style="background: #6f42c1;">Manage Schedule <i class="fas fa-clock"></i></a>
            </div>
            <div class="action-card">
                <i class="fas fa-users-rectangle"></i>
                <h2>Manage Panels</h2>
                <p>Create project defense panels, assign supervisors as members, and view detailed allocation lists.</p>
                <a href="dpc_manage_panels.php" class="action-btn" style="background: #1cc88a;">Launch Panel Manager <i class="fas fa-arrow-right"></i></a>
            </div>
            <div class="action-card">
            ...
            <div class="action-card">
                ...
                <a href="dpc_change_password.php" class="action-btn" style="background: #e74a3b;">Change Password <i class="fas fa-key"></i></a>
            </div>
        </div>
    </div>
