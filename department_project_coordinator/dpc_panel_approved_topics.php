...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['update_topic'])) {
        ...
        if (!empty($new_topic)) {
            ...
            $_SESSION['success'] = "Approved topic updated successfully.";
        }
    }
...
<head>
    <meta charset="UTF-8">
    <title>Panel Update Approved Topics - DPC</title>
...
<body>
    ...
    <div class="page-container">
        <div class="header-card">
            <div>
                <h1><i class="fas fa-check-double"></i> Panel Updates: Approved Topics</h1>
                <p style="color: #636e72; margin-top: 5px;">View and modify topics that have already been approved based on Panel decision.</p>
            </div>
            <a href="dpc_panel_pending_topics.php" class="btn" style="background:#2d3436; text-decoration:none;"><i class="fas fa-arrow-right"></i> Go to Pending Topics</a>
        </div>
        ...
        <div class="main-card">
            ...
            <table>
                ...
                <tbody>
                    <?php if (empty($topics)): ?>
                        <tr><td colspan="3" style="text-align:center; padding: 60px; color: #636e72;">No approved topics found.</td></tr>
                    <?php else: ?>
    ...
    <div id="editTopicModal" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                <h2><i class="fas fa-edit"></i> Update Approved Topic</h2>
