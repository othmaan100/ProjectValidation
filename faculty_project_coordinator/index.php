    ...
    <style>
        * {
        ...
        @media (max-width: 768px) {
            ...
            .stats-grid, .actions-grid, .links-grid { grid-template-columns: 1fr; }
        }
    </style>
</head>
<body>
    ...
    <div class="container">
        ...
        <div class="stats-grid">
            <div class="stat-card">
                ...
                <div class="stat-info"><div class="stat-label">Total DPCs</div><div class="stat-value"><?php echo $totalDPCs; ?></div></div>
            </div>
            <div class="stat-card">
                <div class="stat-icon blue"><i class="fas fa-user-check"></i></div>
                <div class="stat-info"><div class="stat-label">Active DPCs</div><div class="stat-value"><?php echo $activeDPCs; ?></div></div>
            </div>
            <div class="stat-card">
                <div class="stat-icon pink"><i class="fas fa-file-alt"></i></div>
                <div class="stat-info"><div class="stat-label">Total Topics</div><div class="stat-value"><?php echo $totalTopics; ?></div></div>
            </div>
            <div class="stat-card">
                <div class="stat-icon orange"><i class="fas fa-clock"></i></div>
                <div class="stat-info"><div class="stat-label">Pending Topics</div><div class="stat-value"><?php echo $pendingTopics; ?></div></div>
            </div>
            <div class="stat-card">
                <div class="stat-icon green"><i class="fas fa-check-circle"></i></div>
                <div class="stat-info"><div class="stat-label">Approved Topics</div><div class="stat-value"><?php echo $approvedTopics; ?></div></div>
            </div>
            <div class="stat-card">
                <div class="stat-icon teal"><i class="fas fa-building"></i></div>
                <div class="stat-info"><div class="stat-label">Departments</div><div class="stat-value"><?php echo $totalDepartments; ?></div></div>
            </div>
        </div>
        ...
        <div class="actions-grid">
            <div class="action-card fade-in-up">
                <div class="card-icon" style="background: linear-gradient(135deg, #f6d365 0%, #fda085 100%);"><i class="fas fa-building"></i></div>
                ...
                <a href="fpc_manage_departments.php" class="button"><i class="fas fa-arrow-right"></i> Manage Departments</a>
            </div>
            <div class="action-card fade-in-up">
                ...
                <a href="fpc_manage_dpc.php" class="button"><i class="fas fa-arrow-right"></i> Manage DPCs</a>
            </div>
            <div class="action-card fade-in-up">
                ...
                <a href="fpc_upload_past_projects.php" class="button"><i class="fas fa-arrow-right"></i> Upload Projects</a>
            </div>
            <div class="action-card fade-in-up">
                <div class="card-icon" style="background: linear-gradient(135deg, #a8edea 0%, #fed6e3 100%); color: #333;"><i class="fas fa-archive"></i></div>
