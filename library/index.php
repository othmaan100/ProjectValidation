...
<body>
    ...
    <div class="container">
        ...
        <div class="actions-grid">
            ...
            <a href="lib_manage_temp_access.php" class="action-card">
                <i class="fas fa-user-lock main-icon"></i>
                <h2>Guest Access Keys</h2>
                <p>Issue temporary passcodes for students to browse the catalog. Keys expire automatically.</p>
                <div class="btn-act">Manage Access <i class="fas fa-arrow-right"></i></div>
            </a>
        </div>
    </div>
