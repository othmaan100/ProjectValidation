...
if ($role === 'fpc' && !strpos($_SERVER['PHP_SELF'], 'faculty_project_coordinator')) {
    ...
    header("Location: " . PROJECT_ROOT . "department_project_coordinator/index.php");
    exit();
} elseif ($role === 'hod' && !strpos($_SERVER['PHP_SELF'], 'hod')) {
    header("Location: " . PROJECT_ROOT . "hod/index.php");
    exit();
