    ...
    <nav>
        ...
        <?php if (isset($_SESSION['role'])): ?>
            <?php if ($_SESSION['role'] === 'fpc'): ?>
                ...
                <a href="<?= PROJECT_ROOT ?>faculty_project_coordinator/fpc_manage_hod.php" class="<?= isActive('fpc_manage_hod.php', $current_page) ?>">Head of Dept (HOD)</a>
            ...
            <?php elseif ($_SESSION['role'] === 'hod'): ?>
                <a href="<?= PROJECT_ROOT ?>hod/hod_manage_students.php" class="<?= isActive('hod_manage_students.php', $current_page) ?>">Students</a>
                <a href="<?= PROJECT_ROOT ?>hod/hod_manage_supervisors.php" class="<?= isActive('hod_manage_supervisors.php', $current_page) ?>">Supervisors</a>
                <a href="<?= PROJECT_ROOT ?>hod/hod_manage_external_examiners.php" class="<?= isActive('hod_manage_external_examiners.php', $current_page) ?>">External Examiners</a>
                <a href="<?= PROJECT_ROOT ?>hod/hod_assign_supervisors.php" class="<?= isActive('hod_assign_supervisors.php', $current_page) ?>">Allocation</a>
                <a href="<?= PROJECT_ROOT ?>hod/hod_topic_validation.php" class="<?= isActive('hod_topic_validation.php', $current_page) ?>">Validation</a>
                <a href="<?= PROJECT_ROOT ?>hod/hod_panel_pending_topics.php" class="<?= isActive('hod_panel_pending_topics.php', $current_page) ?>">Panel Pending Topics</a>
                <a href="<?= PROJECT_ROOT ?>hod/hod_panel_approved_topics.php" class="<?= isActive('hod_panel_approved_topics.php', $current_page) ?>">Panel Approved Topics</a>
                <a href="<?= PROJECT_ROOT ?>hod/hod_submission_schedule.php" class="<?= isActive('hod_submission_schedule.php', $current_page) ?>">Topic Schedule</a>
                <a href="<?= PROJECT_ROOT ?>hod/hod_report_schedule.php" class="<?= isActive('hod_report_schedule.php', $current_page) ?>">Report Schedule</a>
                <a href="<?= PROJECT_ROOT ?>hod/hod_manage_submissions.php" class="<?= isActive('hod_manage_submissions.php', $current_page) ?>">Submissions</a>
                <a href="<?= PROJECT_ROOT ?>hod/hod_manage_panels.php" class="<?= isActive('hod_manage_panels.php', $current_page) ?>">Panels</a>
                <a href="<?= PROJECT_ROOT ?>hod/hod_view_assessments.php" class="<?= isActive('hod_view_assessments.php', $current_page) ?>">Assessments</a>
                <a href="<?= PROJECT_ROOT ?>hod/hod_chapter_reports.php" class="<?= isActive('hod_chapter_reports.php', $current_page) ?>">Chapter Progress</a>
                <a href="<?= PROJECT_ROOT ?>app_messages.php" class="<?= isActive('app_messages.php', $current_page) ?>">
                    Messages <?php if($unread_count > 0): ?><span style="background: #e74a3b; color: white; padding: 2px 6px; border-radius: 50%; font-size: 10px;"><?= $unread_count ?></span><?php endif; ?>
                </a>
                <a href="<?= PROJECT_ROOT ?>hod/hod_reports.php" class="<?= isActive('hod_reports.php', $current_page) ?>">Reports</a>
                <a href="<?= PROJECT_ROOT ?>hod/hod_change_password.php" class="<?= isActive('hod_change_password.php', $current_page) ?>">Security</a>
