    ...
    <div class="page-container">
        <div class="header-section">
            ...
            <div style="display: flex; gap: 10px;">
                <a href="sup_allocation_report.php" class="btn" style="background: #4e73df; color: white;"><i class="fas fa-print"></i> Print Letter</a>
                <a href="sup_dashboard.php" class="btn btn-back"><i class="fas fa-arrow-left"></i> Back</a>
            </div>
        </div>
